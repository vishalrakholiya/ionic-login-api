...
WalletReceivePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-wallet-receive',template:/*ion-inline-start:"/Volumes/DISK/VISHAL/ionic-login-api/src/pages/wallet-receive/wallet-receive.html"*/'<ion-content class="balance-bg">\n  <ion-refresher (ionRefresh)="doRefresh($event)">\n    <ion-refresher-content pullingIcon="arrow-dropdown" pullingText="Pull to refresh" refreshingSpinner="circles" refreshingText="Refreshing...">\n    </ion-refresher-content>\n  </ion-refresher>\n  <ion-item class="txtCenter">\n    <h4 class=\'black usd\'>{{walletExchangeValue}} USD</h4>\n    <h1 class=\'black btcoin\'>{{walletTokenCount}}</h1>\n    <h3 class=\'black ftb\'>FTB</h3>\n  </ion-item>\n  <ion-list>\n    <ion-item (click)="presentConfirm(tran.idTicket)" *ngFor=\'let tran of transactionList\'>\n      <ion-avatar item-start>\n        <img src="assets/img/ionic3-ico.png">\n        <ion-icon *ngIf="tran.TicketTypeName == \'BUY\' || tran.TicketTypeName == \'SEND\'" class="battery" name="ios-battery-dead"></ion-icon>\n        <ion-icon *ngIf="tran.TicketTypeName == \'SELL\' || tran.TicketTypeName == \'RECEIVE\'" class="battery" name="ios-battery-full"></ion-icon>\n      </ion-avatar>\n      <p>{{tran.TicketTypeName}}<span style="float: right;">{{tran.TDate}}</span></p>\n      <h2 class="text-black cardno">{{tran.Memo}}</h2>\n      <h2 *ngIf="tran.TicketTypeName == \'BUY\' || tran.TicketTypeName == \'SEND\'" class="amountfull">- {{tran.Credit}}</h2>\n      <h2 *ngIf="tran.TicketTypeName == \'SELL\' || tran.TicketTypeName == \'RECEIVE\'" class="amountget">+ {{tran.Debit}}</h2>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"/Volumes/DISK/VISHAL/ionic-login-api/src/pages/wallet-receive/wallet-receive.html"*/
    }),
...
var WalletSendPage = (function () {
    ...
    WalletSendPage.prototype.ionViewDidLoad = function () {
        ...
        this.storage.get('LoggedUserId').then(function (userid) {
            ...
            _this.loginProvider.GetWalletDetails(_this.SenderID).then(function (data) {
                _this.WalletExchangeRate = data[0].WalletExchangeRate;
            });
        });
    ...
    WalletSendPage.prototype.nameCheckClick = function () {
        this.checkBlur();
    };
    WalletSendPage.prototype.ftbCheckClick = function () {
        this.checkFtbBlur();
    };
...
WalletSendPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-wallet-send',template:/*ion-inline-start:"/Volumes/DISK/VISHAL/ionic-login-api/src/pages/wallet-send/wallet-send.html"*/'<ion-content class="balance-bg">\n  <ion-refresher (ionRefresh)="doRefresh($event)">\n    <ion-refresher-content pullingIcon="arrow-dropdown" pullingText="Pull to refresh" refreshingSpinner="circles"\n      refreshingText="Refreshing...">\n    </ion-refresher-content>\n  </ion-refresher>\n  <!-- <p class="payto">Pay To</p>\n  <ion-item>\n    <ion-label>\n      <img class="ftbcoin" src="assets/img/FTB.png" />\n    </ion-label>\n    <ion-input style="color:black" [(ngModel)]=\'RecieverName\' (ionBlur)="checkBlur()" clearInput>\n    </ion-input>\n    <button class="sendbtn checkbtn"  ion-button>CHECK</button>\n  </ion-item> -->\n\n  <ion-grid>\n    <p class="payto">Pay To</p>\n    <ion-row>\n      <ion-col col-10>\n        <ion-item>\n          <ion-label>\n            <img class="ftbcoin" src="assets/img/FTB.png" />\n          </ion-label>\n          <ion-input [(ngModel)]=\'RecieverName\' class="inputpadd0" (ionBlur)="checkBlur()" clearInput> </ion-input>\n        </ion-item>\n      </ion-col>\n      <ion-col col-2>\n          <button class="sendbtn checkbtn" (click)="nameCheckClick()"  ion-button>CHECK</button>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col col-5>\n        <p class="payto">Amount (FTB)</p>\n        <ion-item>\n          <ion-input type="number" [disabled]="FtbDisable" class="inputpadd0" (ionBlur)="checkFtbBlur()" [(ngModel)]=\'FTBAmount\' clearInput></ion-input>\n        </ion-item>\n      </ion-col>\n      <ion-col col-2>\n        <button class="sendbtn checkbtn" (click)="ftbCheckClick()" ion-button>CHECK</button>\n      </ion-col>\n      <ion-col col-5>\n        <p class="payto">Amount (USD)</p>\n        <ion-item>\n          <ion-input type="number" [disabled]="true" [(ngModel)]=\'USDAmount\' class="inputpadd0" clearInput></ion-input>\n        </ion-item>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col col-12>\n        <button class="sendbtn" [disabled]="SendBtnDisable" (click)="sendBtnClick()" ion-button>SEND</button>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ion-list>\n    <ion-item (click)="presentConfirm(tran.idTicket)" *ngFor=\'let tran of transactionList\'>\n      <ion-avatar item-start>\n        <img src="assets/img/ionic3-ico.png">\n        <ion-icon *ngIf="tran.TicketTypeName == \'BUY\' || tran.TicketTypeName == \'SEND\'" class="battery" name="ios-battery-dead"></ion-icon>\n        <ion-icon *ngIf="tran.TicketTypeName == \'SELL\' || tran.TicketTypeName == \'RECEIVE\'" class="battery" name="ios-battery-full"></ion-icon>\n      </ion-avatar>\n      <p>{{tran.TicketTypeName}}<span style="float: right;">{{tran.TDate}}</span></p>\n      <h2 class="text-black cardno">{{tran.Memo}}</h2>\n      <h2 *ngIf="tran.TicketTypeName == \'BUY\' || tran.TicketTypeName == \'SEND\'" class="amountfull">- {{tran.Credit}}</h2>\n      <h2 *ngIf="tran.TicketTypeName == \'SELL\' || tran.TicketTypeName == \'RECEIVE\'" class="amountget">+ {{tran.Debit}}</h2>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"/Volumes/DISK/VISHAL/ionic-login-api/src/pages/wallet-send/wallet-send.html"*/
    }),
